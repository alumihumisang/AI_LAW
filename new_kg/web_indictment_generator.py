...
The research script `XRAG_query_generate.py` is intentionally kept as the
...
try:
    from . import XRAG_query_generate as pipeline
except ImportError:
    import XRAG_query_generate as pipeline
