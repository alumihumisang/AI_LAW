...
"""
Single-case wrapper for web use.

This module deliberately imports the current research pipeline from `new_kg`
so the web layer can stay small while reusing the latest SDKG logic.
"""

from dataclasses import dataclass
from typing import Any

from new_kg import XRAG_query_generate as pipeline
